    ...
    <CRow>
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-medium-emphasis small">
              ...
              readers can announce the number of available links. Use a wrapping <code>&lt;nav&gt;</code> element to
            ...
            <p className="text-medium-emphasis small">
              ...
              descriptive <code>aria-label</code> for the <code>&lt;nav&gt;</code> to reflect its purpose. For example,
              if the pagination component is used to navigate between a set of search results, an appropriate label
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <p className="text-medium-emphasis small">
              While the <code>disabled</code> prop uses <code>pointer-events: none</code> to <em>try</em> to disable the
              link functionality of <code>&lt;a&gt;</code>s, that CSS property is not yet standardized and
              doesn&#39;taccount for keyboard navigation. As such, we always add <code>tabindex=&#34;-1&#34;</code> on
              disabled links and use custom JavaScript to fully disable their functionality.
            </p>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-medium-emphasis small">
              Fancy larger or smaller pagination? Add <code>size=&#34;lg&#34;</code> or <code>size=&#34;sm&#34;</code>{' '}
