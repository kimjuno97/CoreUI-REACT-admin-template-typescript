    ...
    <CRow>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-medium-emphasis small">
              You can add captions to slides with the <code>&lt;CCarouselCaption&gt;</code> element within any{' '}
              <code>&lt;CCarouselItem&gt;</code>. They can be immediately hidden on smaller viewports, as shown below,
              with optional <a href="https://coreui.io/4.0/utilities/display">display utilities</a>. We hide them with{' '}
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-medium-emphasis small">
              Add <code>transition=&#34;crossfade&#34;</code> to your carousel to animate slides with a fade transition
              instead of a slide.
            </p>
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-medium-emphasis small">
              ...
              property. Captions and controls have additional Sass variables that customize the <code>color</code> and{' '}
