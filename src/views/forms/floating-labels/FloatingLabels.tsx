    ...
    <CRow>
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-medium-emphasis small">
              Wrap a pair of <code>&lt;CFormInput&gt;</code> and <code>&lt;CFormLabel&gt;</code> elements in{' '}
              <code>CFormFloating</code> to enable floating labels with textual form fields. A <code>placeholder</code>{' '}
              is required on each <code>&lt;CFormInput&gt;</code> as our method of CSS-only floating labels uses the{' '}
              <code>:placeholder-shown</code> pseudo-element. Also note that the <code>&lt;CFormInput&gt;</code> must
              come first so we can utilize a sibling selector (e.g., <code>~</code>).
            </p>
            ...
            <p className="text-medium-emphasis small">
              When there&#39;s a <code>value</code> already defined, <code>&lt;CFormLabel&gt;</code>s will automatically
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-medium-emphasis small">
              By default, <code>&lt;CFormTextarea&gt;</code>s will be the same height as <code>&lt;CFormInput&gt;</code>
              s.
            </p>
            ...
            <p className="text-medium-emphasis small">
              To set a custom height on your <code>&lt;CFormTextarea;&gt;</code>, do not use the <code>rows</code>{' '}
              attribute. Instead, set an explicit <code>height</code> (either inline or via custom CSS).
            </p>
            <DocsExample href="forms/floating-labels#textareas">
              <CFormFloating>
                <CFormTextarea
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-medium-emphasis small">
              ...
              <code>&lt;CFormSelect&gt;</code>s. They work in the same way, but unlike <code>&lt;CFormInput&gt;</code>s,
              they&#39;ll always show the <code>&lt;CFormLabel&gt;</code> in its floated state.{' '}
              <strong>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-medium-emphasis small">
              When working with the CoreUI for Bootstrap grid system, be sure to place form elements within column
              classes.
            </p>
